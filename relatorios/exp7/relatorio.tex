...
\begin{document}
	...
	\begin{table}[H]
		\begin{center}
			\begin{tabular}{|l|l|l|}
				...
				display7seg{[}0{]} & PIN\_U21  & Output \\ \hline
				display7seg{[}1{]} & PIN\_V21  & Output \\ \hline
				display7seg{[}2{]} & PIN\_W22  & Output \\ \hline
				display7seg{[}3{]} & PIN\_W21  & Output \\ \hline
				display7seg{[}4{]} & PIN\_Y22  & Output \\ \hline
				display7seg{[}5{]} & PIN\_Y21  & Output \\ \hline
				display7seg{[}6{]} & PIN\_AA22 & Output \\ \hline
				...
				rbrRead            & PIN\_C16  & Input  \\ \hline
				reset              & PIN\_B16  & Input  \\ \hline
				resetLSR\_bit1\_3  & PIN\_D17  & Input  \\ \hline
				scope1             & PIN\_H16  & Output \\ \hline
				scope2             & PIN\_H15  & Output \\ \hline
	...
	\begin{itemize}
		...
		\subitem Bit 0: Data Ready (DR) - Resultado:  SUCESSO
		
		\subitem Bit 1: Overrun Error (OE) - Resultado:  SUCESSO
		
		\subitem Bit 2: Parity Error (PE) - Resultado:  SUCESSO
		
		\subitem Bit 3: Framming Error (FE) - Resultado: FALHA
	...
	\subsection*{Comentários}
		Apenas o bit 3 do LSR não apresentou funcionamento correto. O grupo irá repensar a lógica de
		calculo desse bit.
