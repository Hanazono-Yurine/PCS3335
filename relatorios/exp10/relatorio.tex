...
\begin{document}
	...
	de projeto. Desenvolvimento da entidade top level da calculadora e das sub-entidade para cada modo de funcionamento.
	...
	No 3° modo o usuário poderá ler os valores que ja estão armazenados na memoria.
	 ...
	 \begin{itemize}
	 	\item Elaborar a entidade top level que contenha o acesso ao teclado de membrana, acesso à memoria, 
	 	aos displays de 7 segmnetos e consiga alterar entre os modos de funcionamento.
	 	
	 	\item Elaborar o modo 1 de funcionamento.
	 \end{itemize}
	
	\section*{Resultados}
	
	\begin{itemize}
		\item O sistema de alteração entre os modos de funcionamento apresentou comportamento correto.
		
		\item O modo 1 de funcionamento apresentou funcionamento correto.
		
		\item O armazenamento de números na memorias apresentou funcionamento correto.
		
		\item Os modos 2 e 3 ainda precisam ser finalizados.
	\end{itemize}
