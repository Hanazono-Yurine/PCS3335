...
architecture arch_semaforoRaf_1Hz of semaforoRaf_1Hz is
...
begin
    ...
    sig_verde <= '1' when counterOut_verde = "000000000000000000000101" else
                '0';
    ...
    sig_amarelo <= '1' when counterOut_amarelo = "000000000000000000000010" else
                '0';
    ...
    sig_vermelho <= '1' when counterOut_Vermelho = "000000000000000000000101" else
                    '0';    

    -- process
    process(sig_vermelho, sig_amarelo, sig_verde, sig_reset, rst)
    begin
      if rst = '1' then
        state <= Sreset;
