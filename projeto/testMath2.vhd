...
architecture rtl of testMath2 is
	...
	signal bin1, bin2, binResult : std_logic_vector(17 downto 0) := (others => '0') ;
...
begin
    ...
    ascii_o5 <= "0101101" when BCDResult(20) = '1' else "1111111";
