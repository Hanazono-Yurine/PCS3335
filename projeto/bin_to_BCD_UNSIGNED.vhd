...
end entity bin_to_BCD_UNSIGNED;
 
architecture rtl of bin_to_BCD_UNSIGNED is

  signal g_DECIMAL_DIGITS : integer := 5;
  signal g_INPUT_WIDTH : integer := 17;
    ...
    if rising_edge(i_Clock) then
      ...
      case r_SM_Main is
        ...
        when s_ADD =>
          ...
          -- mudei essa parte pra funcionar no quartus
          ...
          elsif r_Digit_Index = 3 then
            v_BCD_Digit := unsigned(r_BCD(15 downto 12));
          else -- r_Digit_Index = 4 then
            v_BCD_Digit := unsigned(r_BCD(19 downto 16));
          end if;
